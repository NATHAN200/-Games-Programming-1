...
void cBalloon::setActive(bool sActive) 			// Set the sprite to active.
{
	mActive = sActive;
}
/*
...
=================
*/
bool cBalloon::isActive() 						// Determine if the sprite is active.
{
	return mActive;
}

void cBalloon::setLaser(D3DXVECTOR2 laserd) 			// Set the Lasers to direction.
{
	LDirection = laserd;
}
/*
...
=================
*/
D3DXVECTOR2 cBalloon::getLaser() 						// Get the laser's direction.
{
	return LDirection;
}